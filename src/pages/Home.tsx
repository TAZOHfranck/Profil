      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className=" font-display font-bold bg-gradient-to-r from-violet-800 to-orange-500 bg-clip-text text-transparent">
              Trouvez l'amour
            </span>
            <br />
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            Votre âme sœur vous attend sur MeetUp.
          </p>
          {!user && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/register"
                className="bg-gradient-to-r from-violet-500 to-orange-500 text-white px-8 py-4 rounded-full hover:from-violet-600 hover:to-orange-600 transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
              >
              ...
              <Link
                to="/login"
                className="border-2 border-violet-500 text-violet-500 px-8 py-4 rounded-full hover:bg-violet-500 hover:text-white transition-colors"
              >
                Se connecter
              </Link>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-6 bg-white rounded-xl shadow-lg">
            <div className="w-16 h-16 bg-gradient-to-r from-violet-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="text-center">
              <div className="w-24 h-24 bg-gradient-to-r from-violet-500 to-orange-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                <Heart className="h-12 w-12 text-white" />
              </div>
              <blockquote className="text-lg italic text-gray-600 mb-4">
                "J'ai trouvé l'amour de ma vie sur MeetUp. Après 6 mois de discussions, 
        ...
        {/* CTA Section */}
        {!user && (
          <div className="text-center mt-16 p-8 bg-gradient-to-r from-violet-500 to-orange-500 rounded-2xl">
            ...
            <Link
              to="/register"
              className="bg-white text-violet-500 px-8 py-4 rounded-full hover:bg-violet-50 transition-colors inline-flex items-center font-semibold"
            >
